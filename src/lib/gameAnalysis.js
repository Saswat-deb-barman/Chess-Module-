...
/**
 * Post-game "defining move" detector — the quantitative half of the Chess
 * Council module (see server/council.js's getCouncilReport for the
 * qualitative half, where the 5 coach personas narrate what this finds).
 *
 ...
 * (independent of play difficulty — see Engine.analyzePosition). Every
 * move gets classified by how much the evaluation swung in the mover's
 * own favor/disfavor versus the position they were handed, which is what
 * both the move timeline and the council's per-move captions are built
 * from.
 *
 ...
 * @param {import("../engine/stockfishWorker.js").Engine} engine - a ready Engine instance
 ...
 * concrete "turning point," matching how Saswat already tracks games
 * outside this app). Remaining slots fill with the largest swings in
 * either direction, capped at maxCount and excluding non-notable moves.
 */
